      ...
      <nav className="bg-gray-100 m-0">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row justify-center items-center pt-4 sm:pt-6 gap-3 sm:gap-8 lg:gap-20 px-4">
          <Link
            ...
            className={`text-gray-800 text-base sm:text-lg lg:text-xl font-medium active:text-teal-600 transition-colors duration-200 border-2 border-gray-500 px-10 sm:px-8 lg:px-16 py-2 sm:py-3 lg:py-2 rounded-lg text-center w-full sm:w-auto
